...
let celciusToDisplay = `${degFahren}\xB0 Fahrenheit is ${tempConversion(degFahren)}\xB0 Celcius`;
let messageToDisplay;


function tempConversion(msgConvert){
   return (5/9)*(msgConvert-32);
}
function tempConversionMsg(msgConvert){
    if(msgConvert < 65){
        messageToDisplay = `Oh, that's cold!`;
    } else if(msgConvert >= 65){
